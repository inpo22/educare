(function(module, $) {
    ...
    self.tree.fn.init = function(option) {
        ...
        // 변수
        self.tree.var.selected_nodeId = final_option.nodeId;
        self.tree.var.selected_tab = final_option.selected_tab;

        var tree_option = {};
        tree_option.data = final_option.data;
        tree_option.nodeDefaultState = final_option.nodeDefaultState;
        // 부서 트리 객체 생성
        self.tree.var.tree = new tui.Tree(final_option.treeId, tree_option);

        // modal 객체
        self.tree.var.tree.createDeptModal = new bootstrap.Modal( document.getElementById(final_option.modalId), final_option.modalOption );
    ...
    // function start
    self.tree.fn.fn명 = function(파라미터){
        /*
        코드 작성
         */
    }
