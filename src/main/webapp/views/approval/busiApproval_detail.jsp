...
<title>${dto.title} - 업무기안 - 에듀케어</title>
		...
		<div class="display-flex">
			...
			<div id="right-section">
				...
				<table class="table table-bordered">
					<tr>
						<th class="table-active first-col">시행일자</th>
						<td class="second-col">
							<fmt:formatDate value="${dto.enf_date}" pattern="yyyy.MM.dd."/>
						</td>
					</tr>
					<tr>
						<th class="table-active">수신부서</th>
						<td>
							<c:forEach items="${receiveTeamList}" var="receiveTeam">
								<span class="badge bg-primary">${receiveTeam.team_name}</span>&nbsp;&nbsp;
							</c:forEach>
						</td>
					</tr>
					<tr>
